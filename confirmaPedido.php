        ...
        <nav class="navbar navbar-expand-lg" style="background-color: #FFC03F;">
            <div class="container-xxl">
                ...
                <div id="botones_tienda_smartphone">
                  <a href="#" class="me-3"><img src="img/usuario.png" alt=""></a>
                  <a  href="carrito.php"><?= count($_SESSION['compra']);?><img src="img/carrito.png" alt=""></a>
              </div> 
    ...
    foreach ($_SESSION["compra"] as $pedido) { 
        ...
        ?>
          <div class="col-lg-3 mt-5 " >
                        <div>
                            <img src=<?= $pedido->getProducto()->getImg(); ?>>
                        </div>
          </div>
          <div class="col-lg-3 mt-5" >

    ...
    <section class="container-fluid mb-5" style="background-color:white" >
        <h2 class="mb-5 fs-1 text-center pt-5">¡NUESTRO RESTAURANTE!</h2>
        <div class="justify-content-md-center seccion_ham position: relative;">
            <button id="button" type="button" class=" btn btn-outline-color1 fw-bold" style=" z-index: 1; height:45px; margin-left:720px; margin-top:130px; width:140px; border-color:black; border-width:3px; border-radius: 20px; position: absolute;" ><a class="nav-link " href=<?=base_url.'/producto/carta'?>>VER CARTA</a></button>
            <video  id="video" controls src=<?=base_url."video/video.mp4"?> width="420"  height="240"></video>
        </div>
...
<button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="clearModalShown()">Close</button>

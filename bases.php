...
?>
    ...
    <section id="banner_carta" class="container-fluid" style="background-image: URL(img/carta.png);">
        <div class="col-12 bannerm">
            <h1 class="mb-3 text-color1">BASES Y CONDICIONES</h1>
        </div>
    </section>
    <section class="text-center">
      <h2 class="ms-5 me-5 mt-5 mb-5"><b>BASES LEGALES DE PARTICIPACIÓN SORTEO “BURGER + BIRRA GRATIS POR UN AÑO”</b></h2>
      <h3 class="ms-5 me-5 mt-5 mb-5"><b>I.- Período.</b></h3>
      <h3 class="ms-5 me-5 mt-5 mb-5">El período de recepción de participaciones del sorteo se iniciará el día 21 de julio de 2023 a las 12:00 h, y finalizará el día 15 de agosto de 2023 a las 23:00 h.</h3>
      <h3 class="ms-5 me-5 mt-5 mb-5"><b>II.- Participantes.</b></h3>
      <h3 class="ms-5 me-5 mt-5 mb-5">Podrán participar en el sorteo todas aquellas personas mayores de edad que residan en algún punto del territorio nacional de España. Quedan excluidos de esta promoción los empleados de BURGERGRILL, además de los empleados de las empresas que intervienen en la gestión de esta promoción. Tampoco podrán participar las personas jurídicas.</h3>
      <h3 class="ms-5 me-5 mt-5 mb-5"><b>III.- Premio.</b></h3>
      <h3 class="ms-5 me-5 mt-5 mb-5">1 combo por semana = 52 semanas desde el miércoles 18 de agosto de 2023 hasta el jueves 18 de agosto de 2023 = máximo de 52 combos (el ganador puede canjearlos en el momento que quiera, no necesariamente uno por semana, pero antes del 19 de agosto de 2023).</h3>
    </section>
